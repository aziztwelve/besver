		...
		<div class="content_day_main">
			...
			<div class="content_day">
				<div class="content_day_info">
					<div class="filter">{!! $sideright->filter !!}</div>
					<div class="time"><p>{!! date('M d, Y  H:i', strtotime($sideright->time_create)) !!}</p></div>
				</div>
				<div class="content_day_content">
					<h2>{!! $sideright->content !!}</h2>
				</div>
				<div class="author">{!! $sideright->author !!}</div>
				<!-- <img class="content_day_image" src="{{ url('img/dev.jpg') }}"> -->
				<div class="content_day_content_main">
					{!! $sideright->content_text !!}
				</div>
			</div>
		</div>
	@endsection
