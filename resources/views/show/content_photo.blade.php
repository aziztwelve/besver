		...
		<div class="content_day_main">
			...
			<div class="content_day">
				<div class="content_day_info">
					<div class="filter">{!! $content_photo->filter !!}</div>
					<div class="time"><p>{!! date('M d, Y  H:i', strtotime($content_photo->time_create)) !!}</p></div>
				</div>
				<div class="content_day_content">
					<h2>{!! $content_photo->content !!}</h2>
				</div>
				<div class="author">{!! $content_photo->author !!}</div>
